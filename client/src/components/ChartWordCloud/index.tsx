...
import { WordCloud  as WordCloudAntd} from '@ant-design/charts';


export const ChartWordCloud= (props: any) => {
...
let api=props.api;
  ...
  const config = {
    ...
    wordField: props.wordField?props.wordField: 'name',
    weightField: props.weightField?props.weightField:'value',
    colorField: props.colorField?props.colorField:'name',
    //imageMask:
